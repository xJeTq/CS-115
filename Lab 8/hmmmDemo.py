...
0 read r1          # Get n 
1 setn r2 1        # initilize r2 as 1 
2 setn r3 0        # initialize r3 as 0 
3 jgtzn r1 5       # done if r > 0
4 halt             # halts if r <= 0
5 write r3         # prints r3 
6 add r3 r2 r3     # adds r2 and r3, and stores it in r3 
7 sub r2 r3 r2     # subtracts r2 from r3, and stores it in r2 
8 addn r1 -1       # subtracts 1 from r1 
9 jumpn 3          # returns to line 3, repeat 
